                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-[#3B3E42]">
                                    <tr>
                                        <th class="px-4 py-4 text-center text-xs font-bold text-white uppercase w-12">No
                                        </th>
                                        <th class="px-4 py-4 text-left text-xs font-bold text-white uppercase">Tingkat
                                        </th>
                                        <th class="px-4 py-4 text-left text-xs font-bold text-white uppercase">Nama
                                            Kelas</th>
                                        <th class="px-4 py-4 text-center text-xs font-bold text-white uppercase">Jumlah
                                            Siswa</th>
                                        <th class="px-4 py-4 text-center text-xs font-bold text-white uppercase">Aksi
                                        </th>
                                    </tr>
                                </thead>
