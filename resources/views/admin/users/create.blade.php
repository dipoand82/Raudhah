                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-8 space-x-4">
                            ...
                            <button type="submit"
                                class="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-2 px-6 rounded-lg shadow-lg transform transition hover:scale-105 duration-300 flex items-center gap-2">
