                    ...
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2 border-t border-gray-200 my-2 pt-4">
                                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Ubah Password
                                    (Opsional)</h3>
                                <p class="text-xs text-gray-400 mb-4">Biarkan kosong jika tidak ingin mengubah password
                                    user ini.</p>
                            </div>
                        ...
                        <div class="flex items-center justify-end mt-8 space-x-4">
                            <a href="{{ route('admin.users.index') }}"
                                class="text-gray-600 hover:text-gray-900 font-medium px-4 py-2 rounded-lg hover:bg-gray-100 transition duration-200">
                                Batal
                            </a>

                            <button type="submit"
                                class="bg-gradient-to-r from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 text-white font-bold py-2 px-6 rounded-lg shadow-lg transform transition hover:scale-105 duration-300 flex items-center gap-2">
