                            ...
                            @forelse($siswas as $siswa)
                                <tr class="hover:bg-indigo-50/50 transition even:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        @if ($siswa->kelas)
                                            <span
                                                class="inline-flex items-center whitespace-nowrap px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 ">
                                                {{ $siswa->kelas->tingkat }} {{ $siswa->kelas->nama_kelas }}
                                            </span>
                                        @else
                                            <span class="text-xs text-red-400 font font-semibold whitespace-nowrap">No
                                                Class</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        @endphp
                                        <span
                                            class="px-3 py-1 inline-flex text-[10px] font-bold border rounded-full {{ $statusClass }}">
