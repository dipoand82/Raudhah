            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <a href="{{ route('galeri.index') }}"
                        class="inline-flex items-center text-blue-600 font-bold hover:gap-3 transition-all gap-2">
                ...
                <div data-aos="fade-in" class="space-y-6">
                    ...
                    <div class="bg-blue-900 p-6 rounded-3xl shadow-lg text-white">
                        ...
                        <a href="#"
                            class="block text-center bg-amber-500 hover:bg-amber-400 text-white font-bold py-2 rounded-xl transition">
                            Hubungi Kami
                        </a>
                    </div>
                </div>
