    ...
    <div class="w-full max-w-sm bg-white rounded-[2rem] shadow-xl border border-gray-100 p-8">
        ...
        <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
            ...
            <div class="w-full text-left">
                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1 px-1">Alamat
                    Email</label>
                <input id="email"
                    ...
                    type="email" name="email" value="{{ old('email') }}" placeholder=" " required autofocus />
        ...
        <div class="mt-8 text-center pt-4 border-t border-gray-50 space-y-3">
            ...
            <a href="{{ url('/') }}"
                class="text-xs font-bold text-gray-400 hover:text-[#1072B8] inline-flex items-center gap-2 transition-colors">
