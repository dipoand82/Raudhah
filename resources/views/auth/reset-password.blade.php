<x-guest-layout>
    ...
    <div class="w-full max-w-sm bg-white rounded-[2rem] shadow-xl border border-gray-100 p-6">
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            {{-- Input Password --}}
            <div class="w-full text-left">
                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1 px-1">Password Baru</label>
                <input id="password"
                       class="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#1072B8] outline-none text-sm font-medium"
                       type="password"
                       name="password"
            ...
            <div class="w-full text-left">
                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1 px-1">Konfirmasi Password</label>
        ...
        <div class="mt-6 text-center pt-4 border-t border-gray-50">
            <a href="{{ route('login') }}" class="text-xs font-bold text-gray-400 hover:text-[#1072B8] inline-flex items-center gap-2">
