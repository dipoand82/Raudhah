    ...
    <div class="h-20 border-b border-gray-200 flex items-center px-4 relative">
        ...
        <a href="{{ url('/') }}" class="flex items-center gap-3 hover:opacity-80 transition-opacity">
            <div
                ...
                <img src="{{ asset('storage/logos/logo_smp_raudhah.png') }}" alt="Logo SMP IT Raudhah"
            ...
            <div class="overflow-hidden">
                <h1 class="text-sm font-bold text-[#1072B8] leading-tight truncate">
                    @if (Auth::user()->role == 'admin')
                        {{ $profil_sekolah->nilai ?? 'SMP IT Raudhah' }}
    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        @if (Auth::user()->role == 'admin')
            ...
            <a href="{{ route('admin.siswas.index') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.siswas.*') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('admin.kelas.index') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.kelas.*') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('admin.tahun-ajaran.index') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.tahun-ajaran.*') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {{ request()->routeIs('admin.keuangan.master.*', 'admin.keuangan.tagihan.*', 'admin.keuangan.pembayaran.*') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-medium">Kelola Tagihan</span>
                    </div>
            ...
            <a href="{{ route('admin.profil.edit') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.profil.*') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z">
                    </path>
                </svg>
                <span class="font-medium">Kelola Konten Profil</span>
            </a>

            <a href="{{ route('admin.manajemen-user.index') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.manajemen-user.*') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z">
                    </path>
        ...
        @elseif(Auth::user()->role == 'guru')
            ...
            <a href="{{ route('profile.edit') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('profile.edit') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @elseif(Auth::user()->role == 'siswa')
            ...
            <a href="{{ route('siswa.keuangan.riwayat') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('siswa.keuangan.riwayat') ? 'bg-[#0A78BD] text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
