...
<nav x-data="{ open: false }" class="bg-white shadow-sm sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center relative">
            ...
            <a href="{{ url('/') }}" class="flex items-center gap-3 z-10 hover:opacity-80 transition-opacity min-w-max">
                @if(file_exists(public_path('storage/logos/logo_smp_raudhah.PNG')))
                    <img src="{{ asset('storage/logos/logo_smp_raudhah.PNG') }}" alt="Logo" class="h-10 w-10 object-contain">
                @elseif($profil_sekolah && $profil_sekolah->logo_path)
                    <img src="{{ asset('storage/' . $profil_sekolah->logo_path) }}" alt="Logo" class="h-10 w-10 object-contain">
                @else
                    <div class="h-10 w-10 bg-[#1072B8] rounded-full flex-shrink-0 flex items-center justify-center text-white text-xs font-bold">SMP</div>
                @endif
            ...
            <div class="hidden md:flex items-center gap-8 absolute left-1/2 transform -translate-x-1/2">
                <a href="#" class="text-sm font-semibold text-gray-600 uppercase transition-all px-3 py-2 hover:text-blue-600 hover:bg-blue-50  rounded-full ">Beranda</a>
                <a href="#info" class="text-sm font-semibold text-gray-600 uppercase transition-all px-3 py-2 hover:text-blue-600 hover:bg-blue-50  rounded-full">Info</a>
                <a href="#galeri" class="text-sm font-semibold text-gray-600 uppercase transition-all px-3 py-2 hover:text-blue-600 hover:bg-blue-50  rounded-full">Galeri</a>
            </div>

            <div class="flex items-center gap-4 z-10">
                @auth
                    <a href="{{ url('/dashboard') }}" class="hidden md:block px-4 py-2 rounded-full text-sm font-bold capitalize text-[#1072B8] bg-white border-2 border-[#1072B8] hover:bg-[#1072B8] hover:text-white hover:scale-105 hover:shadow-lg transition-all duration-200 text-center">
                        Dashboard
                    </a>
                @endauth

                <button @click="open = ! open" class="md:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-blue-600 hover:bg-gray-100 focus:outline-none transition">
    ...
    <div x-show="open"
        ...
        <div class="px-4 pt-2 pb-6 space-y-2">
            <a href="#" @click="open = false" class="block px-4 py-3 rounded-xl text-base font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600">Beranda</a>
            <a href="#info" @click="open = false" class="block px-4 py-3 rounded-xl text-base font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600">Info</a>
            <a href="#galeri" @click="open = false" class="block px-4 py-3 rounded-xl text-base font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600">Galeri</a>
            @auth
                <div class="border-t border-gray-100 my-2"></div>
                <a href="{{ url('/dashboard') }}" class="block px-4 py-3 rounded-xl text-base font-bold text-white bg-blue-600 hover:bg-blue-700 shadow-md text-center">Dashboard</a>
            @endauth
        </div>
    </div>
</nav>
...
<div class="max-w-[1440px] mx-auto">
    <div class="relative bg-gray-900 h-[500px] md:h-[600px] flex items-center justify-center overflow-hidden rounded-md">
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl">
            <h1 data-aos="zoom-in" data-aos-duration="9000" data-aos-delay="500" class="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg mb-4 leading-tight ">
                {{ $profil_sekolah->nama_sekolah ?? 'SMP IT Raudhah' }}
            </h1>
            <p data-aos="fade-up" data-aos-delay="100" class="text-white text-lg md:text-2xl drop-shadow-md font-light mb-8 italic">
...
<section class="scroll-mt-40 py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-3">
            <h2 data-aos="fade-up" class="text-4xl font-extrabold text-blue-900 uppercase tracking-wider animate-gradient-x">SMP IT RAUDHAH</h2>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-16">
            <div data-aos="flip-right" class="group bg-white p-8 rounded-3xl border-t-8 border-blue-600 shadow-lg hover:shadow-2xl transition-all duration-300">
            ...
            <div data-aos="flip-right"  class="group bg-white p-8 rounded-3xl border-t-8 border-green-500 shadow-lg hover:shadow-2xl transition-all duration-300">
                <div class="flex items-center mb-6">
        ...
        <section id="galeri" class="scroll-mt-20">
            <div class="text-center mb-12">
                <h2 data-aos="fade-up" class="text-3xl font-bold text-gray-800 uppercase tracking-widest ">Galeri Kegiatan</h2>
    ...
    <footer data-aos="fade-out" class="bg-gray-900 text-white py-12 mt-20 border-t-4">
        ...
        @if($profil_sekolah) {{-- CEK APAKAH DATA ADA --}}
            @php
        ...
        @endif
            ...
            <a href="{{ $profil_sekolah->instagram ?? '' }}" target="_blank" class="transition-all hover:text-pink-500">
                <i class="fab fa-instagram fa-lg"></i>
            </a>
            <span class="text-gray-600">|</span>
            <a href="{{ $profil_sekolah->tiktok ?? '' }}" target="_blank" class="transition-all hover:text-white">
