    ...
    <div data-aos="fade-in" class="bg-gray-50 min-h-screen pt-6 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <a href="{{ route('galeri.index') }}"
                class="inline-flex items-center text-[#1072B8] mb-4 font-bold hover:gap-3 transition-all gap-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="300" class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                        <img src="{{ asset('storage/' . $item->gambar) }}" class="w-full h-auto object-cover"
                            alt="{{ $item->judul }}">

                        <div class="p-8">
                            <div class="flex items-center gap-3 mb-4 text-sm text-gray-500 font-medium">
                                <span
                                    class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs uppercase">Dokumentasi</span>
                                <span>•</span>
                            ...
                            <div class="prose prose-blue max-w-none text-gray-700 leading-relaxed text-justify break-all"
                ...
                <div data-aos="fade-left" class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-6 rounded-3xl shadow-lg border border-gray-100 group overflow-hidden">
                        <h3
                            class="block mb-4 text-center bg-amber-500 hover:bg-amber-400 text-white font-bold py-2 rounded-xl transition shadow-md">
                            {{ $profil_sekolah->info_penting ?? 'Informasi Penting' }}
                        </h3>

                        <p class="text-sm text-blue-900 text-center mb-5 italic">"Mewujudkan Generasi Cerdas dan Berakhlak
                            Mulia."</p>
