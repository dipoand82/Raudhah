<x-app-layout>
    @if (str_contains(Auth::user()->email, '@raudhah.com') || is_null(Auth::user()->email))
        <div x-data="{ showEmailModal: true }">
            <x-modal name="modal-aktivasi-profil" show="showEmailModal" maxWidth="md" focusable>
                <div class="p-6 text-center">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <x-secondary-button x-on:click="$dispatch('close')"
                            class="w-full bg-white text-gray-600 px-6 py-3 rounded-xl text-sm font-semibold hover:bg-gray-50 transition-all text-center justify-center">
                            Nanti Saja
                        </x-secondary-button>
                    </div>
